...
enemnovo = (
    ...
    .load("s3://datalake-andersonjosesiqueira-511442505751/consumer-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-andersonjosesiqueira-511442505751/consumer-zone/enem")
